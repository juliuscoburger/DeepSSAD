...
class CIFAR10_Dataset(TorchvisionDataset):
    ...
    def __init__(self, root: str, normal_class: int = 5, known_outlier_class: int = 3, n_known_outlier_classes: int = 0,
        ...
        if ratio_known_outlier == 0.0: 
            noise1 = Noise_Dataset(noise=("gaussian",), size=50, image_size=(3,32,32))
            noise2 = Noise_Dataset(noise=("blobs",), size=50, image_size=(3,32,32))
            noise3 = Noise_Dataset(noise=("bernoulli",), size=50, image_size=(3,32,32))
